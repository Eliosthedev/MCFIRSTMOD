...
public class TestmcMod {
	public static final Logger LOGGER = LogManager.getLogger(TestmcMod.class);
	public static final String MODID = "testmc";
	...
	public TestmcMod() {
		...
		TestmcModMobEffects.REGISTRY.register(bus);
