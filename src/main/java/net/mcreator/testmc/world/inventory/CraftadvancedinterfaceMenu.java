...
package net.mcreator.testmc.world.inventory;

import net.mcreator.testmc.TestmcMod;

public class CraftadvancedinterfaceMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CraftadvancedinterfaceMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TestmcModMenus.CRAFTADVANCEDINTERFACE.get(), id);
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 35, 54) {
			private final int slot = 2;
		}));
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 52, 35) {
			private final int slot = 3;
		}));
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 124, 36) {
